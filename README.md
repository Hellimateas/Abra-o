...
- As chaves do Firebase agora ficam em variáveis de ambiente.
- Crie um arquivo `.env.local` na raiz do projeto copiando de `.env.example` e preencha com os valores reais (não versionar).
